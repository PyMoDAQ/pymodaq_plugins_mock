...
class DAQ_2DViewer_TH260_FLIM(DAQ_Viewer_base):
    """
        See Also
        --------
    ...
    params= comon_parameters+[
            ...
            {'title': 'Piezo stage:', 'name': 'piezo_settings', 'type': 'group', 'expanded': True, 'children': [
    ...
    def __init__(self, parent=None, params_state=None):
        ...
        super(DAQ_2DViewer_TH260_FLIM,self).__init__(parent, params_state) #initialize base class with commom attributes and methods
