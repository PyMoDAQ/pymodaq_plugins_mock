...
class AmplitudeSystemsCRC16:
    ...
    def __init__(self, sourceID=0, destID=0x0A):
        ...
        self.status = [dict(name='Temp Amp', value=0, byte=0, bit=0x00),
                       ...
                       dict(name='Amp Fibre Temp', value=0, byte=0, bit=0x02),
                       ...
                       dict(name='Power Drop Warning', value=0, byte=0, bit=0x07),
                       ...
                       dict(name='Memory Error', value=0, byte=2, bit=0x06),
                       dict(name='I.Lock Status', value=0, byte=2, bit=0x07),

                       dict(name='FrontEnd Ready', value=0, byte=3, bit=0x00),
                       dict(name='Trigger Option', value=0, byte=3, bit=0x01),
                       dict(name='Preamp Power Drop Error', value=0, byte=3, bit=0x06),

                       dict(name='Frequency Mod2 in range', value=0, byte=4, bit=0x00),
                       dict(name='Delay Mod2 in range', value=0, byte=4, bit=0x01),
                       dict(name='Width Mod2 in range', value=0, byte=4, bit=0x02),
                       dict(name='Frequency Mod1 in range', value=0, byte=4, bit=0x03),
                       dict(name='Delay Mod1 in range', value=0, byte=4, bit=0x04),
                       dict(name='Width Mod1 in range', value=0, byte=4, bit=0x05),
                       ]
